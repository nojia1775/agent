...
class	Agent
{
	...
	public:
					Agent(void) : _timeDeath(30), _x(0), _y(0), _view(2), _age(0), _hunger(0), _speed(2), _location('0'), _walls({'1', 'A'}), _slower({'O'}), _timeHungry(10), _timeChild(10) {}
					~Agent(void) {}

					Agent(const size_t& x, const size_t& y) : _timeDeath(30), _x(x), _y(y), _view(2), _age(0), _hunger(0), _speed(2), _location('0'), _walls({'1', 'A'}), _slower({'O'}), _timeHungry(10), _timeChild(10) {}
					Agent(const Agent& agent) : _timeDeath(agent._timeDeath), _x(agent._x), _y(agent._y), _view(agent._view), _age(0), _hunger(0), _speed(agent._speed), _location(agent._location), _walls(agent._walls), _slower(agent._slower), _timeHungry(agent._timeHungry), _timeChild(agent._timeChild) {}
